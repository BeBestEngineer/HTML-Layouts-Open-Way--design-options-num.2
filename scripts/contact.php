...
if(trim($subject) == '') {
	echo '<div class="error_message">Пожалуйста, укажите тему сообщения</div>';
	exit();
} else if(trim($msg) == '') {
...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	echo "<h1>Сообщение успешно отправлено!</h1>";
	echo "<p>Спасибо <strong>$name</strong>, Ваше сообщение будет рассмотрено в ближайшее время!</p>";
	echo "</div>";
	echo "</fieldset>";
