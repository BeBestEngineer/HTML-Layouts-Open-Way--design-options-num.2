...
if (trim($name) == '') {
    ...
    echo '<div class="error_message">Пожалуйста укажите правильный формат Вашего e-mail</div>';
    exit();
...
if (trim($number) == '') {
    echo '<div class="error_message">Пожалуйста укажите Ваш номер телефона</div>';
    exit();
}
...
$e_number = "Phone Number: $number" . PHP_EOL . PHP_EOL;
$e_reply = "You can contact $name via email, $email ";

$msg = wordwrap($e_body .$e_email. $e_number. $e_reply, 70);

$headers = "From: $email" . PHP_EOL;
$headers .= "Reply-To: $email" . PHP_EOL;
$headers .= "MIME-Version: 1.0" . PHP_EOL;
//$headers .= array("Content-Type: text/html; charset=UTF-8"). PHP_EOL;
